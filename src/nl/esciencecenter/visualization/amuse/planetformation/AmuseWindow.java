...
public class AmuseWindow implements GLEventListener {
    ...
    private FBO starHaloFBO, pointGasFBO, octreeGasFBO, sphereFBO, starFBO,
            axesFBO, hudFBO, legendTextureFBO;
    ...
    private void starGlow(GL3 gl, FBO target, Quad fullScreenQuad, int passes,
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            starGlowShader = loader.createProgram(gl, "starGlow", new File(
