...
public class NetCDFUtil {
    ...
    public static File getAlternativeExtFile(File initialFile, String altExt) {
        String prefix = getPrefix(initialFile);
        String seqNumber = getSequenceNumber(initialFile);

        File fileTry = new File(prefix + seqNumber + "." + altExt);
