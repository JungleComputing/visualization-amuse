...
public class AmuseGasDataArray implements Runnable {
    ...
    public void run() {
        if (!initialized) {
            ...
            Variable ncdfVar_rho = ncFile
                    .findVariable("particles/0000000001/attributes/rho");
            ...
            try {
                ...
                Array ncdfArray1D_rho = ncdfVar_rho.read();
                ...
                double[] result_u = (double[]) ncdfArray1D_u
                        .get1DJavaArray(double.class);
                double[] result_rho = (double[]) ncdfArray1D_rho
                        .get1DJavaArray(double.class);
